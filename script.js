...
function displayContent() {
    if (localStorage.getItem("loggedIn") === "true") {
        ...
        const messages = [
            ...
            "💕 Peu importe où je suis, tant que tu es dans mon cœur, je suis chez moi. 💕",
            "💕 Question du jour : Si tu pouvais revivre un de nos moments ensemble, lequel choisirais-tu et pourquoi ? 💕",
            "💕 Question du jour : Quelle est la petite chose que je fais qui te fait sourire à coup sûr ? 💕",
            "💕  💕",
            "💕  💕",
            "💕  💕",
            "💕  💕",
